    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      ...
      >
        ...
        <div className="relative mb-8">
          <h1 className="animate-pulse select-none bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text font-bold text-9xl text-transparent md:text-[12rem]">
            404
          </h1>
        ...
        <Link
          ...
          href={"/"}
        >
          <button className="group flex transform items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-600 to-cyan-600 px-6 py-3 font-medium text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-emerald-700 hover:to-cyan-700 hover:shadow-xl">
        ...
        {/* Fun fact */}
        <div className="rounded-lg border border-slate-700 bg-slate-800/30 p-6 backdrop-blur-sm">
      ...
      <div className="absolute top-1/2 left-5 h-8 w-8 animate-ping rounded-full bg-gradient-to-r from-pink-500 to-purple-500 opacity-30" />
      <div
