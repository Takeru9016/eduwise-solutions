export default function DomainsShowcase() {
	const domains: { icon: string; label: string }[] = [
		...
		{ icon: "🎯", label: "Professional Programs" },
	...
	return (
		<section aria-label="Technologies and Domains" className="relative py-14 sm:py-20 bg-gradient-to-b from-primary-99 via-white to-primary-99">
			<div className="container">
				<div className="text-center mb-10 sm:mb-14">
					<h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-grey-15">
						...
						<span className="mx-2 bg-gradient-to-r from-primary-90 via-primary-75 to-primary-90 bg-clip-text text-transparent">technologies</span>
						and
						<span className="ml-2 bg-gradient-to-r from-primary-90 via-primary-75 to-primary-90 bg-clip-text text-transparent">domains</span>
					</h2>

					<p className="mt-4 text-grey-40 max-w-2xl mx-auto">
						Discover curated programs designed with industry experts to make you job‑ready.
					</p>
				</div>
