          ...
          <CardContent className="p-4 lg:p-8">
            <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 mb-4 lg:mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-primary-100 text-xs lg:text-sm leading-relaxed">
                  To become eligible for our Job Guarantee Program, every
                  learner must complete the following Placement Readiness Test
                  (PRT) milestones:
                </p>
              </div>
            </div>
          ...
          <CardContent className="p-4 lg:p-8">
            <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 mb-4 lg:mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-primary-100 text-xs lg:text-sm leading-relaxed">
                  The students need to pay after they get placed. They need to
                  pay INR 20,000 to Eduwise Solutions as a career services fee
                  which can be paid in easy EMIs.
                </p>
              </div>
            </div>
          ...
          <CardContent className="p-4 lg:p-8">
            <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 mb-4 lg:mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-primary-100 text-xs lg:text-sm leading-relaxed">
                  Once you have enrolled for the program then you will have
                  access to a wide range of resources which will help you in
                  becoming a Job-Ready Candidate. We have a dedicated placement
                  team of professionals who excel in their individual domains
                  committed to assist you in your journey.
                </p>
              </div>
            </div>
