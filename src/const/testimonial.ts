export const testimonials = [
  {
    ...
    company: "TCS",
    content:
      "My journey with Eduwise has been truly life-changing. The mentors not only taught me with clarity but also guided me with constant support until I got placed. I’m deeply grateful to the entire Eduwise team for helping me achieve this milestone.",
    avatar: "/testimonials/akshay.jpeg",
    rating: 5,
    linkedinUrl: "https://www.linkedin.com/in/akshay-k-05a52887/",
  },
  {
    id: 2,
    name: "Kushal Sahu",
  ...
  },
  {
    ...
    company: "Saarthi IAS",
    content:
      "As a fresh graduate, I was anxious about my career. Eduwise helped me build confidence, polish my resume, and create a strong LinkedIn profile. Their guidance landed me a remote job that fit perfectly. Thank you, Eduwise!",
